...
class Entregador extends Usuario {
    ...
    public void finalizarEntrega(Pedido pedido) {
        if (entregas.contains(pedido) && pedido.getStatus().equals("Em Andamento")) {
            //TODO -> alterar o status do pedido para "Finalizado"
            //TODO -> atualizado o horário final do pedido para o horário atual
            //TODO -> calcula e guarda o valor ganho da corrida de 70% do valor total da entrega
            //TODO -> atualiza o ganho total do entregador
